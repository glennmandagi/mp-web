<div class="container clearfix">
    ...
    <div class="shortcodes"> 
		<div class="sixteen columns bottom-2">
			<form action="<?=base_url()?>admin/gallery/add_do" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-elements">	
				<fieldset>
					<label>Tittle : </label>
					<?
					$data = array(
					...
					<input type="hidden" name="gallery_h_id" value="<?=$gallery_h_id?>">
